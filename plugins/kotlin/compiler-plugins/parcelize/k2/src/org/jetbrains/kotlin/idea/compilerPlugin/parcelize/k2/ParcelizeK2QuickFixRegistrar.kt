...
class ParcelizeK2QuickFixRegistrar : KotlinQuickFixRegistrar() {
    override val list = KtQuickFixesListBuilder.registerPsiQuickFix {
        ...
        registerFirQuickFix(KtErrorsParcelize.OVERRIDING_WRITE_TO_PARCEL_IS_NOT_ALLOWED,
        ...
        registerFirQuickFix(KtErrorsParcelize.CREATOR_DEFINITION_IS_NOT_ALLOWED, K2ParcelMigrateToParcelizeQuickFix.FACTORY_FOR_CREATOR)
